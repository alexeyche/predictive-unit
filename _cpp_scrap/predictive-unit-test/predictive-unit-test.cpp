...
void TestBaseTalk() {
...

	{
		...
		sc0->set_id(0);
		sc0->set_simulationtime(2000);
		sc0->mutable_layerconfig()->set_layersize(10);
		...
		sc1->set_id(1);
		sc1->set_simulationtime(2000);
		sc1->mutable_layerconfig()->set_layersize(10);
		sc1->mutable_layerconfig()->set_inputsize(10);
